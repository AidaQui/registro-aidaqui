...
export default function SupportCard() {
  return (
    <div className="ticket-support">
      <div className="ticket-support__text">
        <p className="ticket-support__lead">
          Si tienes dudas o necesitas otro método de pago
        </p>
        <p className="ticket-support__title">CONTACTA CON SOPORTE</p>
      </div>
      <a
        href={soporteUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="ticket-support__btn"
      >
        <span className="ticket-support__icon" aria-hidden="true">
          <WhatsAppIcon />
        </span>
        Hablar con soporte
      </a>
